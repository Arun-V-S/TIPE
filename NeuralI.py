...
for _, _, f in os.walk(pathCroix):
    for issou in f:
        imgCROIX.append(loadimage(pathCroix + issou))

for _, _, f in os.walk(pathRond):
    for issou in f:
        imgROND.append(loadimage(pathRond + issou))
...
Layer1 = Layer('1', 100, 50, type='input')
Layer2 = Layer('2', 50, 20, type='hidden')
Layer3 = Layer('3', 20, 10, type='hidden')
Layer4 = Layer('4', 10, 2, type='hidden')
